...
{
public:
  CancelComputeAndTrackRouteServer()
...
class CancelComputeAndTrackRouteActionTestFixture : public ::testing::Test
{
public:
...
CancelComputeAndTrackRouteActionTestFixture::factory_ = nullptr;
std::shared_ptr<BT::Tree> CancelComputeAndTrackRouteActionTestFixture::tree_ = nullptr;

TEST_F(CancelComputeAndTrackRouteActionTestFixture, test_ports)
{
  std::string xml_txt =
    R"(
      <root BTCPP_format="4">
        <BehaviorTree ID="MainTree">
             <CancelComputeAndTrackRoute name="ComputeAndTrackRouteCancel"/>
        </BehaviorTree>
      </root>)";
...
int main(int argc, char ** argv)
{
  ...
  CancelComputeAndTrackRouteActionTestFixture::action_server_ =
    std::make_shared<CancelComputeAndTrackRouteServer>();
  std::thread server_thread([]() {
      rclcpp::spin(CancelComputeAndTrackRouteActionTestFixture::action_server_);
    });
